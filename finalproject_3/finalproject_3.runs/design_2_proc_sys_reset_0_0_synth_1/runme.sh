...
HD_PWD='D:/Xilinx/finalproject_3/finalproject_3.runs/design_2_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_proc_sys_reset_0_0.tcl
